...
dmd -version=minimal -ofbin/reggae -Isrc -Ipayload -Jpayload/reggae src/reggae/{reggae_main,options,reggae}.d payload/reggae/{options,types,build,config}.d payload/reggae/rules/{common,defaults}.d
